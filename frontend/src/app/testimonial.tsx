          ...
          >
            <div className="w-full mb-10 lg:mb-0">
              ...
              <Typography
                ...
                placeholder={"Description"}
              >
                Great institute to learn many computer courses required to be competitive in current market at a very affordable prices. I completed Advanced Excel course here and was very satisfied with the effort and energy put by the tutor in making sure that all my doubts are cleared.
              </Typography>
              <Typography
                variant="h6"
                color="blue-gray"
